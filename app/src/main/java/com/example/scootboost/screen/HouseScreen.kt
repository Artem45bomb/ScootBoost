    ...
    Box(modifier) {
        ...
        Column(
            ...
            Column(
                ...
                BtnLight(text = stringResource(R.string.sign_btn_signin)) {
                    navController.navigateSingleTopTo(Login.route)
                }
                BtnLight(text = stringResource(R.string.sign_btn_register)) {
                    navController.navigateSingleTopTo(Registration.route)
                }
                BtnLight(text = stringResource(R.string.sign_btn_without_signin)) {
